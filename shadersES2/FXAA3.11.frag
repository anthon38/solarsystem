...
void main()
{
        FxaaFloat2 _pos = textureCoord;
        FxaaFloat4 fxaaConsolePosPos = vec4(0);
        //FxaaTex tex = u_texture;
        //FxaaTex fxaaConsole360TexExpBiasNegOne = u_texture;
        //FxaaTex fxaaConsole360TexExpBiasNegTwo = u_texture;
        FxaaFloat2 fxaaQualityRcpFrame = 1.0/resolution;
        ...
        FxaaFloat fxaaQualityEdgeThreshold = 0.333;
    ...
    gl_FragColor = FxaaPixelShader(_pos, fxaaConsolePosPos, texture2d, texture2d, texture2d, fxaaQualityRcpFrame,
